...
The modelling technique must enable predictions about throughput for varying levels of skewed demand.  It must also be possible to compose system models from simpler components.  Two approaches for the latter are programming or mathematical language-based models (e.g. {\itshape CloudSim} or {\itshape Process Algebra} respectively).
